<template>
    <div>
        ...
        <p>LetsDoThis ("us", "we", or "our") operates the https://letsdothis.2myfiles.com website (hereinafter referred to as
            the "Service").</p>

        <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use
            our Service and the choices you have associated with that data. Our Privacy Policy is managed by the for LetsDoThis
            is <a href="https://termsfeed.com/privacy-policy/generator/">the Privacy Policy Generator</a>.</p>
        ...
        <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of
            ...
            https://letsdothis.2myfiles.com</p>

        <h2>Definitions</h2>
        <ul>
            <li>
                <p><strong>Service</strong></p>
                <p>Service is the https://letsdothis.2myfiles.com website operated by LetsDoThis</p>
            </li>
            <li>
        ...
        <p>LetsDoThis uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
            that transfer.</p>
        <p>LetsDoThis will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
        ...
        <p>LetsDoThis may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of LetsDoThis</li>
